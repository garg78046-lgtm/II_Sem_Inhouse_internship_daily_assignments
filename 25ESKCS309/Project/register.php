...
<head>
    ...
    <title>Re..Form..ers | Real Time Form Validation</title>
    <link rel="icon" type="image/svg+xml" href="assets/form-validation.svg" />
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container"><a class="navbar-brand text-white fw-bold" href="#page-top">Re..Form..ers</a><button
    ...
    <footer class="footer py-4">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12 text-center">Copyright © Re..Form..ers 2026 | Real Time Form Validation Project
                </div>
            </div>
        </div>
    </footer>
